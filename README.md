...
### Process:
I am considering using these new characteristics to replace original characteristics. But for my computation power's limitation, now this *autoencoder* model has been running for 13hrs, I will update outcome after its running. 
We plan to build XGboost model using new new characteristics generated by *autoencoder*.
